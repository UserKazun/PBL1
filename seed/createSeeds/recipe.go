...
func CreateSeedRecipes() {
	...
	recipesInfos := []map[string]string{
		map[string]string{ //1
			...
			"CategoryID":  "2",
			"ImageURL":    "https://www.sirogohan.com/_files/recipe/images/gyuudon/gyuudon2008.JPG",
			"Price":       "150",
			"Point":       "15",
		},
		map[string]string{ //2
			...
			"CategoryID":  "7",
			"ImageURL":    "https://www.kaihouse.jp/wp-content/uploads/2018/08/gourmet4346_s.jpg",
			"Price":       "200",
			"Point":       "20",
		},
		map[string]string{ //3
			...
			"Description": "",
			"CategoryID":  "5",
			"ImageURL":    "https://c-www.gnst.jp/dressing/image/article/23/20423/carousel_eaf3d0db85dbfaee1769e451438336ef.jpg",
			"Price":       "200",
			"Point":       "20",
		},
		map[string]string{ //4
			...
			"Description": "米オンリー",
			"CategoryID":  "7",
			"ImageURL":    "https://www.uchinokome.com/html/upload/temp_image/0329021017_5abbcc7905fd9.JPG",
			"Price":       "50",
			"Point":       "5",
		},
